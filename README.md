...
Your task is to develop a small .NET Core application. We need you to build your application in your own GitHub repository.  Please do not fork our repository to create your project.  Once you are done, send us a link to your repository.
...
- Feel free to use any third party library you would find useful
- Please do not use database, we are more interested in your coding skills than your SQL skills
